---------------------
-- Cache startup settings for ships
...
local boat_power = 300 + (speed_modifier-1)*150
	...
	layers = {
		{
			...
			direction_count = 256,
			allow_low_quality_rotation = true,
			filenames = {"__cargo-ships__/graphics/blank.png"},
			line_length = 16,
			lines_per_file = 16,
			scale = 3,
			shift = {0.0, -0.7}
...
local ship_power = 2000 + (speed_modifier-1)*1200
