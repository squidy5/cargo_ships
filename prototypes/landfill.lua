...
tile_test_item.collision_mask = {"train-layer", "player-layer"}  -- waterway_layer added in data-final-fixes
...
tile_player_test_item.collision_mask = {"water-tile", "player-layer"}
tile_player_test_item.collsion_box = {{-1,-1.2},{1,1.2}}

data:extend({
  tile_test_item,
  tile_player_test_item,
  {
    type = "item",
    name = "tile_test_item",
